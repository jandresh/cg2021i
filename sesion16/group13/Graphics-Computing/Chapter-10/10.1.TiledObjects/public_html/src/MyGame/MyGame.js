...
MyGame.prototype.initialize = function () {
  ...
  this.mIllumHero = new Hero(
    this.kMinionSprite,
    this.kMinionSpriteNormal,
    20,
    30
  );
  this.mLgtHero = new Hero(this.kMinionSprite, null, 60, 50);
  this.mIllumMinion = new Minion(
    this.kMinionSprite,
    this.kMinionSpriteNormal,
    25,
    30
  ...
  for (i = 0; i < 4; i++) {
    this.mIllumHero
      .getRenderable()
      .addLight(this.mGlobalLightSet.getLightAt(i));
...
MyGame.prototype.update = function () {
  ...
  this.mGlobalLightSet
    .getLightAt(3)
    .set2DPosition(this.mLgtHero.getXform().getPosition());
...
MyGame.prototype._selectCharacter = function () {
  ...
  if (gEngine.Input.isKeyClicked(gEngine.Input.keys.Five)) {
    ...
    this.mMaterialCh = this.mSlectedCh
      .getRenderable()
      .getMaterial()
      .getDiffuse();
