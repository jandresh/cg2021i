...
function Minion(spriteTexture, atY, speed) {
    this.kDelta = speed / 100;
    this.kDeltaSpeed = 0.0001;
    this.mMinion = new SpriteAnimateRenderable(spriteTexture);
    this.mMinion.setColor([1, 1, 1, 0]);
    this.mMinion.getXform().setPosition(105, atY);
    this.mMinion.getXform().setSize(7, 4.6);
