...
SceneFileParser.prototype.parseDoors = function (texture0, texture1, texture2, lightSet) {
    ...
    for (i = 0; i < elm.length; i++) {
        ...
        d = new Door(x, y, texture0, texture1, texture2, lightSet, t);
...
SceneFileParser.prototype.parseButtons = function (texture0, texture1, texture2, texture3, lightSet) {
    ...
    for (i = 0; i < elm.length; i++) {
        ...
        t = Number(elm.item(i).attributes.getNamedItem("Type").value);
        if(t == 0){
            b = new Button(x, y, texture0, t, lightSet);
        }else if (t == 1){
            b = new Button(x, y, texture1, t, lightSet);
        }else if (t == 2){
            b = new Button(x, y, texture2, t, lightSet);
        }else if (t == 3){
            b = new Button(x, y, texture3, t, lightSet);
        }
