...
Hero.prototype.changeBodyHero = function (newTexture) {
    this.mDye = new LightRenderable(newTexture);
    if (this.mHeroState !== this.mPreviousHeroState) {
       /*switch (this.mHeroState) {
            case Hero.eHeroState.eFaceLeft:
                this.mDye.setSpriteSequence(80, 100, 80, 80, 1, 10);
                this.mDye.getXform().setSize(10, 10);
                this.mDye.setAnimationSpeed(20);
                break;
            case Hero.eHeroState.eFaceRight:
                this.mDye.setSpriteSequence(70, 40, 60, 80, 1, 0);
                this.mDye.getXform().setSize(4, 4);
                this.mDye.setAnimationSpeed(20);
                break;
            case Hero.eHeroState.eRunLeft:
                this.mDye.setSpriteSequence(0, 100, 80, 80, 1, 0);
                this.mDye.getXform().setSize(1, 1);
            ...
            case Hero.eHeroState.eJumpLeft:
                this.mDye.setSpriteSequence(0, 100, 30, 30, 1, 0);
                this.mDye.getXform().setSize(1, 1);
                this.mDye.setAnimationSpeed(4);
                break;
            case Hero.eHeroState.eJumpRight:
                this.mDye.setSpriteSequence(0, 0, 30, 30, 1, 0);
                this.mDye.getXform().setSize(1, 1);
                this.mDye.setAnimationSpeed(4);
                break;
        }*/
