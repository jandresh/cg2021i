...
SceneFileParser.prototype.parseMinions = function (texture, normal, lightSet) {
    ...
    for (i = 0; i < elm.length; i++) {
        ...
        //gEngine.LayerManager.removeFromLayer(gEngine.eLayer.eActors, m);
...
SceneFileParser.prototype.parseDoors = function (texture0, texture1, texture2, lightSet ,level) {
    ...
    for (i = 0; i < elm.length; i++) {
        ...
        d = new Door(x, y, texture0, texture1, texture2, lightSet ,level);
...
SceneFileParser.prototype.parseImage = function (level,refCam) {
    var elm = this._getElm("Background");
    var dir = "assets/" + level + "/";
    var i, j, x, y, z, w, h, p, t, n, bg, bgR, l, s;
    for (i = 0; i < elm.length; i++) {
