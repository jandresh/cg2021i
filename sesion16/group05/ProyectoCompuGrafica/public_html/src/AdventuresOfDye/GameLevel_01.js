...
function GameLevel_01(level , lifepoints) {
...
GameLevel_01.prototype.unloadScene = function () {
    ...
    if (this.mRestart === true)
    {
        ...
        var nextLevel = new GameLevel_02(this.mNextLevel,this.life);  // next level to be loaded
        gEngine.Core.startScene(nextLevel);
    }
...
GameLevel_01.prototype.initialize = function () {
    ...
    var d = parser.parseDoors(this.kDoorTop, this.kDoorBot, this.kDoorSleeve, this.mGlobalLightSet ,1);
...
GameLevel_01.prototype.update = function () {
    ...
    //console.log(this.mGlobalLightSet)
    console.log(this.mAllMinions)
